import{s as t,r as p,c as w,j as a,e as o,aB as k,h as A,R as m,aC as b,aD as C,u as h,a as D,aE as I,aF as P,x as _}from"./index--dd59e357.js";import{D as S,c as j,d as F,e as R}from"./DialogContent.4ac042a6.js";import{D as z,a as E}from"./DialogTitle.da98250c.js";t.div`
  display: flex;
...
`;function L({interviewers:d}){const[e,x]=p.exports.useState(),[c,r]=p.exports.useState(!1),[l,u]=p.exports.useState(""),i=p.exports.useRef(null),n=()=>{r(!0)};w(()=>{(async()=>{const y=await fetch((e==null?void 0:e.image.slice(0,18))+":8080"+(e==null?void 0:e.image.slice(18)),{headers:new Headers({Authorization:`${A.defaults.headers.common.Authorization}`})}).then(g=>g.blob()).then(g=>(console.log(URL.createObjectURL(g)),URL.createObjectURL(g)));u(y)})()},[e]);const f=()=>{r(!1)},v=s=>{s.currentTarget.src="/default.png"};return d?a(O,{children:[d.map(s=>o(B,{children:a(T,{onClick:()=>{x(s),n()},children:[s.name," - ",s.nickname]})},s.pk)),a(S,{open:c,onClose:f,scroll:"paper","aria-labelledby":"scroll-dialog-title","aria-describedby":"scroll-dialog-description",fullWidth:!0,children:[a(z,{id:"scroll-dialog-title",children:[e==null?void 0:e.name," - ",e==null?void 0:e.nickname]}),o(j,{dividers:!0,children:a(E,{id:"scroll-dialog-description",tabIndex:-1,children:[o(k,{ref:i,src:l,alt:"\uBA74\uC811\uAD00 \uC0AC\uC9C4",onError:v}),a("p",{children:["Email : ",e==null?void 0:e.email]}),a("p",{children:["\uBD80\uC11C : ",e==null?void 0:e.department]})]})}),o(F,{children:o(R,{onClick:f,children:"\uD655\uC778"})})]})]}):null}const H=m.lazy(()=>b(()=>import("./ApplicantPDFViewer.05e3620d.js"),["ApplicantPDFViewer.05e3620d.js","index--dd59e357.js","index.595782a5.css","DialogContent.4ac042a6.js","tiny-invariant.esm.d11e6c56.js","DialogTitle.da98250c.js"])),N=m.lazy(()=>b(()=>import("./ReviewAccordion.e16a5b4d.js"),["ReviewAccordion.e16a5b4d.js","jsx-runtime_commonjs-proxy.148aaf30.js","index--dd59e357.js","index.595782a5.css","DialogContent.4ac042a6.js","Tooltip.03575610.js"])),W=t.div`
  display: flex;
  width: 100vw;
  height: 100%;
  gap: 60px;
